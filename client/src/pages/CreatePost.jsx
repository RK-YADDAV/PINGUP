      ...
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          <div className='flex items-center gap-3'>
            <img src={user.profile_picture} alt="" className='w-12 h-12 rounded-full shadow-sm' />
            <div>
            ...
            <div className='flex flex-wrap gap-2 mt-4'>
              {images.map((image, i) => (
                <div key={i} className='relative group'>
                  ...
                  <div onClick={()=>setImages(images.filter((_,index)=> index!== i))} className='absolute hidden 
                  group-hover:flex justify-center items-center top-0 bottom-0 right-0 left-0 bg-black/40 
