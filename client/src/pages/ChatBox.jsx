    ...
    <div className='flex flex-col h-screen'>
        ...
        <div className='space-y-4 max-w-4xl mx:auto'>
          {
            messages.toSorted((a, b) => new Date(a.createdAt) - new Date(b.createdAt)).map((message, index) => (
              <div key={index} className={`flex flex-col ${message.to_user_id !== user.id ? 'items-start' : 'items-end'}`}>
      ...
      <div className='px-4'>
        ...
        mx-auto border border-gray-200 shadow rounded-full mb-5'>
          ...
          hover:from-indigo-700 hover:mask-b-to-purple-800 active:scale-95 cursor-pointer text-white p-2 rounded-full'>
