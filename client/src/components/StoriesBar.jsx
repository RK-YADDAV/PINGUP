        ...
        <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4'>
            <div className='flex gap-4 pb-5'>
                ...
                {stories.map((story, index) => (
                    ...
                    cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 
                    active:scale-95`}>
                        <img 
                        ...
                        <p className='text-white absolute bottom-1 right-1 z-10 text-xs'>
                            {moment(story.createdAt).fromNow()}</p>
                            {
                                story.media_type !== 'text' && (
                                    <div className='absolute insert-0 z-1 rounded-lg bg-black overflow-hidden'>
                                        {
                                            story.media_type === 'image' ?
                                                <img src={story.media_url} alt='' className='h-full w-full 
                                                object-cover hover:scale-110 transition duration-500 opacity-70 hover:opacity-80'/>
                                            : 
