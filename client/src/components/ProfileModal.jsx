...
const ProfileModal = ({setShowEdit}) => {
  ...
  return (
    <div className='fixed top-0 bottom-0 left-1 right-0 z-110 h-screen overflow-y-scroll bg-black/50'> 
                ...
                <div className='flex flex-col items-start gap-3'>
                    <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                        ...
                        <div className='group/profile relative'>
                            ...
                            bg-black/20 rounded-full justify-center items-center'>
                ...
                <div className='flex flex-col items-start gap-3'>
                    <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                        ...
                        <div className='group/cover relative'>
                            ...
                            : user.cover_photo} alt="" className='w-80 h-40 rounded-lg bg-gradient-to-r 
                            from-indigo-200 via-purple-200 object-cover mt-2'/>
                            <div className='absolute hidden group-hover/cover:flex top-0 left-0 right-0 bottom-0 
                            bg-black/20 rounded-lg justify-center items-center'>
                                <pencil className='w-5 h-5 text-white'/>
                            </div>
                        </div>
                    </label>
